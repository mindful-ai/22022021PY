...
class extEmployee(Employee):
    ...
    def __init__(self, n, age, company, salary="1000000 INR"):
...
e1 = extEmployee('Anil', 35, 'Oracle')
e2 = extEmployee(n='Sunil',  company='Oracle', age=45, salary="2000000 INR")
